...
Explanation | Example
-- | --
All errors identify the exact file, and source datapack where the error originated. Some error messages are improved for clarity or have additional context added where possible. | <pre>Parsing Error: Value provider too low (must be >= 0), got -1<br>&emsp;  at 'placement'<br>&emsp;  at 'cyanide:worldgen/placed_feature/ore_tin' defined in 'file/Test.zip'</pre>
